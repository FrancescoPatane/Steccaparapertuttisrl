...
#associo a ogni anno nella lista il mese con minor vendita
for (a in lanni){
    annomese = names(lmesi[grepl(paste("^",a,sep=""), names(lmesi))])[which.min(lmesi[grepl(paste("^",a,sep=""), names(lmesi))])]
